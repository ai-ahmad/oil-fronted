  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-4xl font-bold text-black">Хиты продаж</h1>
        {/* Custom navigation buttons */}
        <div className="flex space-x-2">
          <button
            className="swiper-button-prev-custom h-10 w-10 text-white bg-[#CBCBCB] p-2 rounded-full"
          >
            ←
          </button>
          <button
            className="swiper-button-next-custom h-10 w-10 text-white bg-[#CBCBCB] p-2 rounded-full"
          >
            ➔
          </button>
        </div>
